...
# EpicUltraHD4k8k - checkpoints
/opt/environments/python/comfyui/bin/huggingface-cli download NorbyXL/checkpoints \
    --include "epicultrahd4K8K16K1024K_v10.safetensors"
