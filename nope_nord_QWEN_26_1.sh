...
function provisioning_download() {
 ...
 # Adding the Hugging Face CLI command
    /opt/environments/python/comfyui/bin/huggingface-cli download NorbyQWEN/loras --cache-dir $WORKSPACE/.cache --local-dir $WORKSPACE/ComfyUI/models/loras
	/opt/environments/python/comfyui/bin/huggingface-cli download NorbyQWEN/diffusion_models --cache-dir $WORKSPACE/.cache --local-dir $WORKSPACE/ComfyUI/models/diffusion_models
	/opt/environments/python/comfyui/bin/huggingface-cli download NorbyQWEN/text_encoders --cache-dir $WORKSPACE/.cache --local-dir $WORKSPACE/ComfyUI/models/text_encoders
