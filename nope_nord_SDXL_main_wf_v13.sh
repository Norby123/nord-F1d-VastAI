...
LORA_MODELS=(
    # Showing ass - Pony
	"https://civitai.com/api/download/models/1571294?type=Model&format=SafeTensor"
	# Lesbian kissing - Pony 
	"https://civitai.com/api/download/models/1539640?type=Model&format=SafeTensor"
