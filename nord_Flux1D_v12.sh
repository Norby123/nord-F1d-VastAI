...
git clone "https://${HF_TOKEN}@huggingface.co/Norby/loras" /workspace/ComfyUI/models/loras

fi

git pull "https://${HF_TOKEN}@huggingface.co/Norby/loras" /workspace/ComfyUI/models/loras

TARGET_DIR="/workspace/ComfyUI/models/loras"
REPO_URL="https://${HF_TOKEN}@huggingface.co/Norby/loras"
