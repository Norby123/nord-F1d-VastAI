...
CHECKPOINT_MODELS=(
	...
	"https://civitai.com/api/download/models/1355240?type=Model&format=SafeTensor&size=pruned&fp=fp8"
	"https://civitai.com/api/download/models/1086292?type=Model&format=SafeTensor&size=full&fp=fp16"
    )
