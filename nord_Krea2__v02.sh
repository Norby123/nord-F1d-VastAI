...
# 2. Szukseges mappak elokeszitese (Abszolut utvonalakkal)
...
for model_id in "${KREA_BASES[@]}"; do
    aria2c -x 16 -s 16 -k 10M -c --content-disposition --header="Authorization: Bearer $CIVITAI_TOKEN" \
...
# Ide nem kell a --content-disposition, mert a link vege mar maga a fajlnev!
