...
#    /opt/environments/python/comfyui/bin/huggingface-cli download Norby/loras --cache-dir $WORKSPACE/.cache --local-dir $WORKSPACE/ComfyUI/models/loras
    ...
    /opt/environments/python/comfyui/bin/huggingface-cli download Norby/Z_Image_Loras --cache-dir $WORKSPACE/.cache --local-dir $WORKSPACE/ComfyUI/models/loras
	
	/opt/environments/python/comfyui/bin/huggingface-cli download Norby/Z_Image_diffusion_models --cache-dir $WORKSPACE/.cache --local-dir $WORKSPACE/ComfyUI/models/diffusion_models
	
	/opt/environments/python/comfyui/bin/huggingface-cli download Norby/Z_Image_text_encoders --cache-dir $WORKSPACE/.cache --local-dir $WORKSPACE/ComfyUI/models/text_encoders
	
	/opt/environments/python/comfyui/bin/huggingface-cli download Norby/Z_Image_model_patches --cache-dir $WORKSPACE/.cache --local-dir $WORKSPACE/ComfyUI/models/model_patches
	
# aria2c -x16 -s16 --dir="$WORKSPACE/ComfyUI/models/text_encoders" \
# -o qwen_3_4b_z_imgae_turbo.safetensors \
#"https://huggingface.co/Comfy-Org/z_image_turbo/resolve/main/split_files/text_encoders/qwen_3_4b.safetensors"

#aria2c -x16 -s16 --dir="$WORKSPACE/ComfyUI/models/text_encoders" \
#-o qwen_bf16_3_4b_z_img_turbo.gguf.safetensors \
#"https://huggingface.co/unsloth/Qwen3-4B-GGUF/resolve/main/Qwen3-4B-BF16.gguf"
...
#aria2c -x16 -s16 --dir="$WORKSPACE/ComfyUI/models/diffusion_models" \
#-o z_image_de_turbo_v1_bf16.safetensors \
