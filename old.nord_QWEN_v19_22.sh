...
function provisioning_start() {
  ...
  # --- Force-create symlinks for diffusion_models and text_encoders ---
    echo "Ensuring ComfyUI model subfolders link to storage path..."
    ln -sf "$WORKSPACE/storage/stable_diffusion/models/diffusion_models" "$WORKSPACE/ComfyUI/models/diffusion_models"
    ln -sf "$WORKSPACE/storage/stable_diffusion/models/text_encoders" "$WORKSPACE/ComfyUI/models/text_encoders"
    echo "Symlinks created (diffusion_models, text_encoders)"
